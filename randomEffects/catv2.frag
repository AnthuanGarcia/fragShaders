...
float mouth2(vec2 uv) {

    return plot( abs(ELLIPSE(vec2(0.7, 1.0), (uv - vec2(0, 0.03)), 0.03)), 0.0075 ) +
...
float mouth3(vec2 uv) {

    return plot( ( ELLIPSE(vec2(0.7, 1.0), uv, 0.06) ) , 0.01 ) +
    plot(
        abs(parabola(uv + vec2(0., 0.125), 0.05, -0.015)),
        0.012
    );
}
